...
systemctl enable tokumei-initialize.service
systemctl enable tokumei-autorun.service
...
# Update pacman.conf
sed -i -e '/# ==== BEGIN Tokumei Repository ====/,/# ==== END Tokumei Repository ====/d' /etc/pacman.conf
